...
export class HelpCommand extends Command {
    ...
    public async chatInputRun(interaction: Command.ChatInputCommandInteraction) {
        ...
        let embed = new EmbedBuilder()
            ...
            .setDescription("Commands are put into categories named `modules`. Using the selection menu you can get a list of commands under a module. If further assistance is needed feel free to join our [support server](https://discord.gg/komibot).")
        ...
        if(getModule) {
            ...
            const module = this.container.stores.get("commands").categories.filter(c => c).includes(getModule);
            console.log(module)
